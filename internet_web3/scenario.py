...
# Standalone showcase: the "repo root" defaults to the example root itself.
# Optional qualification reports under ${repo_root}/target/web3-* simply do
# not exist here, so the orchestrator skips attaching them (the fail-closed
# behavior still fires if the caller passes --require-base-sepolia-smoke).
