...
export async function sha256Hex(bytes: ArrayBuffer | Uint8Array): Promise<string> {
  // Normalize to a fresh Uint8Array so crypto.subtle sees a concrete
  // BufferSource without the SharedArrayBuffer-tolerant typing that newer
  // @types/node emits on .buffer.slice().
